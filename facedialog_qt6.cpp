...
#else
    // OpenCV non disponible - utiliser MXFace API ou mode simple
    QMessageBox::information(this, "Information",
                             "Reconnaissance faciale locale (OpenCV) non disponible.\n"
                             "Utilisez l'API MXFace pour la reconnaissance faciale cloud.");
    // Vous pouvez appeler MXFace API ici si nécessaire
#endif // OPENCV_AVAILABLE
}
